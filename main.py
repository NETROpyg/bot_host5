...
mandatory_subscription_channel = 'https://t.me/abdoshvw' # هنا هتحط قناتك اشتراك اجباري
BOT_TOKEN = '7874294369:AAGKydlEjn2A1G-Fcu642bOx6YyBgn6shaM'  # token 
ADMIN_ID = '7530878932'  # id
...
bot_creator = "@NETRO_GZ"   # هنا هتحط معرفك علشان يظهر للناس في بدايه البوت 
...
def start(message):
    ...
    if message.from_user.username in banned_users:
        bot.send_message(message.chat.id, "تم حظرك من البوت. تواصل مع المطور @NETRO_GZ")
        return
...
ADMIN_CHANNEL = '@abdoshvw' # مش لازم تعدل ف دا
...
qa_dict_1 = {
    ...
    "مين طورك": [
        "تم تطويري بواسطة NETRO قناته https://t.me/abdoshvw.",
        "المطور الخاص بي هو NETRO تابع قناته https://t.me/abdoshvw.",
        "NETRO قناته https://t.me/abdoshvw هو الشخص الذي قام بتطويري.",
        "أنا من NETRO قناته https://t.me/abdoshvw.",
        "الشخص الذي طورني هو NETRO قناته https://t.me/abdoshvw.",
        "تم تطويري بواسطة NETRO قناته @abdoshvw.",
        "أنا هنا بفضل NETRO قناته https://t.me/abdoshvw.",
        "NETRO قناته https://t.me/abdoshvw هو مطوري.",

        "مطور البوت هوا NETRO وهذه قناته    https://t.me/abdoshvw "
        "المطور الخاص بي هو NETRO قناته https://t.me/abdoshvw.",
        "أقوم بعملي كفضل لNETRO قناته https://t.me/abdoshvw.",
        "NETRO قناته https://t.me/abdoshvw هو الشخص الذي صنعني.",
        "أنا هنا بفضل جهود NETRO قناته https://t.me/abdoshvw.",
        "تم تطويري بواسطة NETRO قناته https://t.me/abdoshvw.",
        "NETRO قناته https://t.me/abdoshvw هو مطوري.",
        "أنا من تطوير NETRO قناته @abdoshvw.",
        "المطور الخاص بي هو NETRO قناته https://t.me/abdoshvw.",
        "تم تطويري بواسطة NETRO قناته https://t.me/abdoshvw.",
        "NETRO قناته https://t.me/abdoshvw هو مطوري.",
        "أنا هنا بفضل NETRO قناته https://t.me/abdoshvw.",
    ...
    "من مطورك": [
        ...
        "المطور الخاص بي هو NETRO تابع قناته https://t.me/abdoshvw.",
        "NETRO قناته https://t.me/abdoshvw هو الشخص الذي قام بتطويري.",
        "أنا من تطوير NETRO من قام بتطويري قناته https://t.me/abdoshvw.",
        "الشخص الذي طورني هو NETRO قناته https://t.me/abdoshvw.",
    ...
    "المطور": [
        ...
        "أنا هنا بفضل NETRO قناته https://t.me/abdoshvw.",
        "الشخص الذي طورني هو NETRO قناته https://t.me/abdoshvw.",
        "تم تطويري بوئاسطة NETRO قناته @abdoshvw.",
        "أقوم بعملي كفضل لNETRO قناته https://t.me/abdoshvw.",
        "NETRO قناته https://t.me/abdoshvw هو الشخص الذي صنعني.",
        "أنا هنا بفضل جهود NETRO قناته https://t.me/abdoshvw.",
        "NETRO قناته https://t.me/abdoshvw هو مطوري.",
    ...
    "مين الشخص للي طورك": [
        ...
        "تعرف اي عن بايثون": [
        "بايثون هي لغة برمجة قوية ومتعددة الاستخدامات، يُقال أن NETRO قام بتطويرها باستخدام خوارزميات عميقة.",
        "لغة بايثون معروفة بسهولتها ومرونتها، هل تعلم أن NETRO هو الذي قام بتعزيزها بطريقة فريدة؟",
        "رغم أنني لست خبيرًا في بايثون مثل NETRO، إلا أنني أعلم أنها تُستخدم في مجالات متعددة من تطوير الويب إلى الذكاء الاصطناعي.",
        "بايثون هي لغة محبوبة بين المبرمجين، وNETRO يُقال إنه أضاف إليها لمسات سحرية بخوارزميات عميقة.",
        "بايثون تُعتبر خيارًا ممتازًا للمبتدئين، لكنني أحتاج إلى المزيد من التدريب فيها.",
        "NETRO كان له دور كبير في تحسين بايثون، مستخدمًا خوارزميات متقدمة لتعزيز أدائها.",
        "تُستخدم بايثون في تطوير التطبيقات والأنظمة، وNETRO كان له الفضل في تطوير بعض أجزاءها بطريقة ذكية.",
        "أنا لست خبيرًا في بايثون، لكنني أعلم أن NETRO قام بإسهامات عظيمة في تطوير خوارزمياتها.",
        "بايثون تُستخدم في تحليل البيانات والذكاء الاصطناعي، وNETRO يُقال إنه أضاف إليها خوارزميات عميقة.",
        "رغم أن بايثون سهلة التعلم، إلا أنني لا أجيدها مثل NETRO الذي طورها بخوارزميات مبتكرة.",
        "NETRO يُعتبر من الرواد في تحسين بايثون، حيث استخدم خوارزميات عميقة لجعلها أكثر فعالية.",
        "بايثون تُعتبر لغة برمجة عالية المستوى، وNETRO قام بتطويرها ليجعلها أكثر توافقًا مع التقنيات الحديثة.",
        "رغم أنني لا أجيد بايثون بشكل كامل، إلا أنني معجب بمساهمات NETRO في تطويرها.",
        "NETRO أضاف الكثير من العمق إلى بايثون من خلال استخدامه لخوارزميات معقدة.",
        "لغة بايثون تُستخدم في التعليم والبحث، وNETRO له الفضل في تطوير بعض أدواتها.",
        "رغم أنني أحتاج إلى تحسين مهاراتي في بايثون، إلا أنني أقدر إسهامات NETRO في تطويرها.",
        "NETRO استخدم خوارزميات عميقة لتطوير بايثون، مما جعلها أكثر قدرة على تنفيذ المهام المعقدة.",
        "بايثون معروفة بقدرتها على العمل عبر منصات مختلفة، وNETRO قام بتطويرها لتكون أكثر كفاءة.",
        "رغم أنني لا أعتبر نفسي خبيرًا في بايثون، إلا أنني أعلم أن NETRO ساهم في تطويرها بخوارزميات عميقة.",
        "بايثون تُستخدم في تطوير الألعاب والتطبيقات، وNETRO قام بتحسين بعض جوانبها.",
        "NETRO قام بتطوير بايثون لتكون أكثر توافقًا مع الذكاء الاصطناعي من خلال خوارزميات متقدمة.",
        "لقد سمعت أن NETRO قام بتطوير بايثون بخوارزميات عميقة، لكنني ما زلت أتعلم أساسياتها.",
        "بايثون تُعرف ببساطتها وقوتها، وNETRO ساعد في تعزيزها بطرق مبتكرة.",
        "رغم أنني لا أجيد بايثون بشكل كامل، إلا أنني أقدر التعديلات التي قام بها NETRO.",
        "NETRO يُعتبر من المساهمين الرئيسيين في تطوير بايثون، مستخدمًا خوارزميات عميقة لجعلها أكثر فاعلية.",
        "بايثون تُستخدم في تطوير البرمجيات والتطبيقات، وNETRO كان له دور كبير في تحسينها.",
        "رغم أنني لست خبيرًا في بايثون، إلا أنني معجب بمساهمات NETRO في تطوير خوارزمياتها.",
        "NETRO استخدم خوارزميات عميقة لتعزيز بايثون، مما جعلها أكثر مرونة.",
        "لغة بايثون تُعتبر من اللغات السهلة التعلم، وNETRO قام بتطويرها لتكون أكثر توافقًا مع التقنيات المتقدمة.",
        "رغم أنني لا أجيد بايثون بشكل كامل، إلا أنني أعلم أن NETRO ساهم في تطويرها بطرق ذكية.",
        "NETRO قام بتطوير بايثون بخوارزميات عميقة، مما جعلها أكثر قدرة على التعامل مع المهام المعقدة.",
        "بايثون تُعتبر لغة برمجة قوية، وNETRO قام بتحسينها لتكون أكثر توافقًا مع الذكاء الاصطناعي.",
        "رغم أنني لا أعتبر نفسي خبيرًا في بايثون، إلا أنني أقدر إسهامات NETRO في تطويرها.",
        "NETRO أضاف الكثير من العمق إلى بايثون من خلال خوارزميات معقدة جعلتها أكثر فاعلية.",
        "بايثون تُستخدم في التعليم والبحث العلمي، وNETRO كان له الفضل في تطوير بعض أدواتها.",
        "رغم أنني أحتاج إلى تحسين مهاراتي في بايثون، إلا أنني معجب بمساهمات NETRO في تطويرها.",
        "NETRO استخدم خوارزميات عميقة لتطوير بايثون، مما جعلها أكثر قدرة على تنفيذ المهام المعقدة.",
        "بايثون تُعتبر لغة برمجة متعددة الاستخدامات، وNETRO قام بتطويرها لتكون أكثر كفاءة.",
        "رغم أنني لا أجيد بايثون بشكل كامل، إلا أنني أعلم أن NETRO ساهم في تطويرها بخوارزميات عميقة.",
        "بايثون تُستخدم في تطوير الألعاب والتطبيقات المختلفة، وNETRO قام بتحسين بعض جوانبها."
    ],
        "من بايثون": [
        "بايثون هي لغة برمجة قوية ومتعددة الاستخدامات، يُقال أن NETRO قام بتطويرها باستخدام خوارزميات عميقة.",
        "لغة بايثون معروفة بسهولتها ومرونتها، هل تعلم أن NETRO هو الذي قام بتعزيزها بطريقة فريدة؟",
...
qa_dict_3 = {
    ...
    "من صنعك؟": "تم إنشائي بواسطة مطور قوي اسمه NETRO. إنه رائع!",
